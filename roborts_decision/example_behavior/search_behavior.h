...
roborts_decision::Blackboard::Ptr transptr4(roborts_decision::Blackboard* &blackboard){
...
class SearchBehavior:public ActionNode {
 public:
  SearchBehavior(ChassisExecutor* &chassis_executor,
                Blackboard* &blackboard,
                const std::string & proto_file_path) :ActionNode::ActionNode("search",transptr4(blackboard)),chassis_executor_(chassis_executor),
