...
roborts_decision::Blackboard::Ptr transptr3(roborts_decision::Blackboard* &blackboard){
...
class PatrolBehavior:public ActionNode {
 public:
  PatrolBehavior(ChassisExecutor* &chassis_executor,
                 ...
                 const std::string & proto_file_path):ActionNode::ActionNode("patrol",transptr3(blackboard)) ,chassis_executor_(chassis_executor),
