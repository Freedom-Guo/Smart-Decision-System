...
roborts_decision::Blackboard::Ptr transptr1(roborts_decision::Blackboard* &blackboard){
...
class ChaseBehavior:public ActionNode {
 public:
  ChaseBehavior(ChassisExecutor* &chassis_executor,
                Blackboard* &blackboard,
                const std::string & proto_file_path) : ActionNode::ActionNode("chase",transptr1(blackboard)),chassis_executor_(chassis_executor),
