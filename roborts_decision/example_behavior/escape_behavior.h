...
roborts_decision::Blackboard::Ptr transptr2(roborts_decision::Blackboard* &blackboard){
...
class EscapeBehavior:public ActionNode {
 public:
  EscapeBehavior(ChassisExecutor* &chassis_executor,
                 Blackboard* &blackboard,
                 const std::string & proto_file_path) :ActionNode::ActionNode("eacape",transptr2(blackboard)),
