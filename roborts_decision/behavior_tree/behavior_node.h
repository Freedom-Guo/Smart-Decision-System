...
#ifndef ROBORTS_DECISION_BEHAVIOR_NOD
...
public:
  ...
  /**
   * @brief Constructor of BehaviorNode without params
   */
  BehaviorNode(){}

  /**
   * @brief Constructor of BehaviorNode with some params
  ...
  BehaviorNode(std::string name, BehaviorType behavior_type, const Blackboard::Ptr &blackboard_ptr):
      ...
      level_(0){}
 /**
  * @brief The destructor of BehaviorNode
  */
...
class CompositeNode: public BehaviorNode{
 public:
  ...
  /**
   * @brief Cancels the executing nodes
   */
  virtual void Cancel()
  {
    if(GetChildrenNum()==1)
    ...
    {
      GetChildren()[GetChildrenIndex()]->Cancel();
    }
  }
}
 protected:
...
class SelectorNode: public CompositeNode{
 ...
 protected:
  ...
  //! the list of reeavaluation state for each child node
